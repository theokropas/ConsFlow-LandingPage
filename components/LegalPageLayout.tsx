    ...
    <div className="bg-white px-4 py-12 sm:px-6 lg:px-8 lg:py-20">
      <article className="mx-auto max-w-3xl">
        ...
        <header className="mt-7 border-b border-line pb-7">
          ...
          <p className="mt-4 text-base leading-7 text-steel">{subtitle}</p>
          <p className="mt-3 text-xs text-steel">Última actualización: {updatedAt}</p>
        </header>
        <div className="legal-content mt-7">{children}</div>
      </article>
    </div>
  );
}
